...
const ModalDriver = ({openModal,setOpenModal,modalData}) => {
  return (
    <Modal show={openModal} size="sm" popup onClose={() => setOpenModal(false)}>
        ...
        <div className='flex flex-row gap-2'>
           {modalData.avatar?(
             <img className="mb-3 w-[60px] h-[60px] rounded-full shadow-lg" src={`${modalData.avatar}`} alt="" />
            ):(
              <InitialsAvatar 
                name={modalData.name} 
                size={60} 
        ...
        <div className='flex flex-row gap-2'>
           <FaCar className='text-2xl  text-gray-900 dark:text-white'/>
           <p className='font-semibold text-gray-900 dark:text-white'>{modalData.veiculo.modelo}</p>
           <p className='font-semibold text-gray-900 dark:text-white'>{modalData.veiculo.cor}</p>
           <p className='font-semibold text-gray-900 dark:text-white'>{modalData.veiculo.placa}</p>
        </div>
